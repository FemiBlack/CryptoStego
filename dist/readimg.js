import { bits_to_str, dct, extract_block, get_bit_from_quantized, get_hashed_order, img_16x16_to_8x8, rgb2ycbcr } from "./utils";
...
// main function
export function readMsgFromCanvas_base(canvasid, enc_key = "", use_dct = false, num_copy = 5, multiply = 30, loc = [1, 2, 8, 9, 10, 16, 17], use_y = true, use_downsampling = true) {
