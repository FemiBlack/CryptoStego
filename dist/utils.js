...
export function get_hashed_order(password, arr_len) {
    // O(arr_len) algorithm
...
export function str_to_bits(str, num_copy) {
...
export function replace_block(mat, block_size, x_min, y_min, img_num_col, new_data) {
    for (var i = 0; i < block_size; i++)
        for (var j = 0; j < block_size; j++) {
